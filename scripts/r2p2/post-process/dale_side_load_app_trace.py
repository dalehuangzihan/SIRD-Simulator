...
def side_load_incast_fbCacheFollowerDist_load_fullsweep_10to1_1458B_5000ns():
    ''' --- Side-load & analyse existing app trace file ---'''
    proto_name = dale_experiment_rig.SSIRD_PROTO_NAME
    ...
    print(f"Protos tested: {proto_name}")
    ...
    exp_metrics, flow_stats_dict = dale_experiment_rig.ExperimentGroup.process_side_loaded_results(proto_name, src_dst_pairs_list, num_flows_list, src_dst_pairs_to_flowspecs_dict_list, target_flow_rate_gbps, app_trace_paths_list)
...
if __name__ == "__main__":
    ...
    side_load_incast_fbCacheFollowerDist_load_fullsweep_10to1_1458B_5000ns()