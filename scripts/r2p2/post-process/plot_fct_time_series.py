...
def plot_ssird_manyconn_dctcp_fct_1000000B_varying_period():
...
if __name__ == "__main__":
    ...
    plot_ssird_manyconn_dctcp_fct_1000000B_varying_period()
    plot_ssird_dctcp_manyconn_fct_sweep_1gbps_100gbps()