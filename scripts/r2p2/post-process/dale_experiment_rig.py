...
class Flow:
    ...
    def init_byteloads(self):
        for i in range(0, self.num_byteloads):
            ...
            is_final_byteload = (i == self.num_byteloads-1) # is the last byteload in the flow
            self.byteloads_list.append(Byteload(self.src, self.dst, self.id, self.byteload_size_B, rel_timestamp_us, absolute_timestamp_us, is_final_byteload))
...
class FlowStats:
    ...
    def check_flow_stats(self):
        ...
        assert(self.total_bytes_sent_B == expected_flow_size_B)
