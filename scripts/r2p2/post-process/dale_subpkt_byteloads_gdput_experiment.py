...
def fct_vs_load_experiment_vary_byteloadsize_subpkt_multiflow(is_full_postproc=True, title_addendum="_subpkt_multiflow"):
    ...
    dale_multiflow_serialiser.init_logs(output_path=f"experiment_output/subpkt_multiflow_experiment_{total_flow_size_B}B_total_{min(byteload_size_B_list)}B_to_{max(byteload_size_B_list)}B.log")
...
if __name__ == "__main__":
    ...
    fct_vs_load_experiment_vary_byteloadsize_subpkt_multiflow(is_full_postproc=False)
