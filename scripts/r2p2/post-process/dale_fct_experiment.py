...
if __name__ == "__main__":
    ...
    # fct_vs_thrpt_experiment_vary_interval(is_capture_output=True, is_full_postproc=False)
    fct_vs_thrpt_experiment_vary_byteloadsize(is_capture_output=True, is_full_postproc=False)
