...
def onertt_delay_p2p_lowload():
    ...
    run_experiment(
        ...
        # title_addendum="_20host_500Bto100KB_8GbpsFlo_1msRTT_allproto_1flo_test",
        title_addendum="_500Bto100KB_8GbpsFlo_1msRTT_allproto_1flo",
        log_level=dale_experiment_rig.LOG_LEVEL_2,
        experiment_date=dale_experiment_rig.Experiment.get_date_now_formatted()
    ) 
    print("FE_NEW_1rtt_delay_1msRTT_" + "_500Bto100KB_8GbpsFlo_1msRTT_allproto_test")
...
def onertt_delay_p2p_flowrate_sweep():
    ...
    run_experiment(
        ...
        title_addendum="_1458B_2000nsTo150ns_1msRTT_allproto",
        log_level=dale_experiment_rig.LOG_LEVEL_2,
        experiment_date=dale_experiment_rig.Experiment.get_date_now_formatted(),
        is_all_same_flowrate=False
    ) 
    print("FE_NEW_1rtt_delay_flowrate_sweep_1msRTT_"+"_1458B_2000nsTo150ns_1msRTT_allproto_test")
...
def incast_10to1_1458B_fbHadoopDist_800ns_load_fullsweep_v5():
    ...
    print("FE_NEW_incast_12host_fullsweep_v5_" + "_12host_fbHadoopDist_loadtest_800ns_fromjson")
...
if __name__ == "__main__":
    # rmb: only run 1 func at a time, don't run multiple exp funcs or else log files will screw up
    pass
