...
def experiment_vary_byteload_number_1flo(is_full_postproc=True, title_addendum="", log_level=dale_experiment_rig.LOG_LEVEL_2):
    ...
    num_byteloads_per_flow_list = [10000, 1000, 100, 10]
    ...
    ssird_sim_dur_list = [0.12, 0.12, 0.12, 0.12]
    dctcp_sim_dur_list = [0.2, 0.2, 0.2, 0.2]
...
def experiment_vary_byteload_size_1flo(is_full_postproc=True, title_addendum="", log_level=dale_experiment_rig.LOG_LEVEL_2):
...
def experiment_vary_interval_1flo(is_full_postproc=True, title_addendum="", log_level=dale_experiment_rig.LOG_LEVEL_2):
...
if __name__ == "__main__":
    ### 1ms RTT experiments:
    experiment_vary_byteload_number_1flo(is_full_postproc=True, title_addendum="_vary_num_bload_1flo_1msRTT", log_level=dale_experiment_rig.LOG_LEVEL_2)
    # experiment_vary_byteload_size_1flo(is_full_postproc=True, title_addendum="_vary_bload_size_1flo_1msRTT", log_level=dale_experiment_rig.LOG_LEVEL_2)
    # experiment_vary_interval_1flo(is_full_postproc=True, title_addendum="_vary_interval_1flo_1msRTT", log_level=dale_experiment_rig.LOG_LEVEL_2)
