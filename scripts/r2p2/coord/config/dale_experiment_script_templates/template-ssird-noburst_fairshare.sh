...
manual_req_interval_file_l='DUMMY'
client_injection_rate_gbps_list='60' # value is meaningful only when req_interval_distr is not 'manual'
# when manual, this specifies the sim duration in secods. For 3 1MB flows at 100Gbps, it takes approx 3*80us = 0.00024sec
duration_modifier_l='DUMMY'
mean_req_size_B_l='121848' # only meanigful if req_size_distr is not manual

# ===================== Debugging Options =====================
# From 1 to 7 (7 = super verbose). Set it to 0 to enable the following, more fine-grain options
global_debug='6' 
