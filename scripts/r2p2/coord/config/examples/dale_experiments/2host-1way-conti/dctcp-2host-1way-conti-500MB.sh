...
manual_req_interval_file_l='dale_experiments/2host-1way-conti/2host-1way-conti-1MB.csv'
client_injection_rate_gbps_list='60' # value is meaningful only when req_interval_distr is not 'manual'
duration_modifier_l='0.004' # when manual, this specifies the sim duration in secods. for 3 1mb flows at 100gbps, it takes approx 3*80us = 0.00024sec
