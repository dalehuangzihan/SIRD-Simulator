...
manual_req_interval_file_l='example-simple-incast.csv'
...
r2p2_unsolicited_thresh_bytes_l="72000 -1"
...
# ===================== Protocols =====================
transp_prots='micro-hybrid micro-hybrid'
simulation_name_l='SIRD-paper SIRD-unsched'
