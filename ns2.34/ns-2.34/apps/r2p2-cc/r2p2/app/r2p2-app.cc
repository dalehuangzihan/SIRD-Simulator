...
void R2p2Application::send_request(RequestIdTuple *, size_t)
{
    ...
    slog::log4(debug_, local_addr_, "R2p2Application::send_request(). srvr_addr:", srvr_addr, "srvr_thread:", srvr_thread, "clnt_thread:", clnt_thread, "app_level_id_:", app_level_id, "reqs_sent_:", reqs_sent_, "payload:", next_req_size, "is_final_req_of_conn", is_final_req_of_conn);
    r2p2_layer_->r2p2_send_req(next_req_size, RequestIdTuple(app_level_id,
                                                             local_addr_, srvr_addr,
                                                             clnt_thread, srvr_thread,
                                                             is_final_req_of_conn,
